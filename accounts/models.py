...
#     def __str__(self):
#         return f"{self.user.get_full_name()} - {self.company_name or 'Individual Agent'}"
...
#     # Ownership
#     vendor = models.ForeignKey("accounts.CustomUser", on_delete=models.CASCADE, related_name="properties")
